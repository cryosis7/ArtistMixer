...
import { SelectArtists } from '@features/artistMixer/selectArtists/components/SelectArtists';
import { RefinePlaylist } from '@features/artistMixer/refinePlaylist/components/RefinePlaylist';
import { Generate } from '@features/artistMixer/generatePlaylist/components/Generate';
import { useAuth } from '@features/auth/hooks/useAuth';
import { draftPlaylistAtom } from '@state/playlistAtoms';

export const ArtistMixer: React.FC = () => {
